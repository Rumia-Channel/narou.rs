...
- 2026-04-19追加: Web UI の単体/一括削除 API は、削除成功時に `PushServer::broadcast_echo` で console history へ削除ログを出す。`concurrency` 有効時は非外部通信として `#console-stdout2`、無効時は `#console` を使う。
