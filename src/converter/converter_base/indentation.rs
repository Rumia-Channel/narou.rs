...
static RE_PROLONGED_SOUND: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"\u{30FC}{2,}").unwrap());
static RE_HEAD_HALF_SPACES: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"(?m)^ +").unwrap());
