...
const ELEMENT_IDS = [
  ...
  'library-backup-modal', 'library-backup-close', 'library-backup-size',
  'library-backup-space-warning', 'library-backup-output',
  'library-backup-dismiss', 'library-backup-create',
